...
gym.register(
    id='LeIsaac-OMX-PickOrange-v0',
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pick_orange_omx_env_cfg:PickOrangeOMXEnvCfg",
    },
)

gym.register(
    id='LeIsaac-OMX-PickOrange-Mimic-v0',
    entry_point=f"leisaac.enhance.envs:ManagerBasedRLLeIsaacMimicEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.pick_orange_omx_mimic_env_cfg:PickOrangeOMXMimicEnvCfg",
    },
)
