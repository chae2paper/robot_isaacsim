...
gym.register(
    id="LeIsaac-OMX-LiftCube-Mimic-v0",
    entry_point=f"leisaac.enhance.envs:ManagerBasedRLLeIsaacMimicEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_cube_omx_mimic_env_cfg:LiftCubeOMXMimicEnvCfg",
    },
)

gym.register(
    id="LeIsaac-OMX-LiftCube-v0",
    entry_point="isaaclab.envs:ManagerBasedRLEnv",
    disable_env_checker=True,
    kwargs={
        "env_cfg_entry_point": f"{__name__}.lift_cube_omx_env_cfg:LiftCubeOMXEnvCfg",
    },
)
